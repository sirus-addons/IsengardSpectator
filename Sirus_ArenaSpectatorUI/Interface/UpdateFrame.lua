...
function ezSpectator_UpdateFrame:Create()
    ...
    self.MainFrame:SetBackdrop({
        ...
        edgeFile = 'Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Textures\\TooltipEdge',
    ...
    self.Line1:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 12, 'OUTLINE')
    ...
    self.Line2:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.Line3:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.Line4:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.LinkHolder:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 12, 'OUTLINE')
    ...
    self.Line5:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
