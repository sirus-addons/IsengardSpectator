...
function ezSpectator_ClickIcon:Create(Parent, ParentFrame, Style, Size, ...)
	...
	self.Text:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSans.ttf', 8, 'OUTLINE')
...
function ezSpectator_ClickIcon:SetIcon(Name)
	...
	if Record then
		...
		local Texture = self.Textures:Load(self.Icon, 'Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Textures\\Icons\\' .. Record[1])
