...
function ezSpectator_AuraIcon:Create(Parent, ParentFrame, Size, ...)
    ...
    self.StackCount:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.Overlay:SetTexture('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Textures\\AuraIcon_Border')
