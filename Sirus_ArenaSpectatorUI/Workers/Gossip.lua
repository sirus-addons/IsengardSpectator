...
function ezSpectator_GossipWorker:ShowMatch(Match)
    ...
    if not Match.MainFrame then
        ...
        Match.MainFrame.CentralFrame.Info1:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\RobotoCondensed-Regular.ttf', 14, 'OUTLINE')
        ...
        Match.MainFrame.CentralFrame.Info2:SetFont('Interface\\FrameXML\\Sirus_ArenaSpectatorUI\\Fonts\\RobotoCondensed-Regular.ttf', 14, 'OUTLINE')
